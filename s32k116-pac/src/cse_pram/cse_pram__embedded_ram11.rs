#[doc = "Register `_EmbeddedRAM11` reader"]
pub struct R(crate::R<CSE_PRAM__EMBEDDEDRAM11_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CSE_PRAM__EMBEDDEDRAM11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CSE_PRAM__EMBEDDEDRAM11_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CSE_PRAM__EMBEDDEDRAM11_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `_EmbeddedRAM11` writer"]
pub struct W(crate::W<CSE_PRAM__EMBEDDEDRAM11_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CSE_PRAM__EMBEDDEDRAM11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CSE_PRAM__EMBEDDEDRAM11_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CSE_PRAM__EMBEDDEDRAM11_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "CSE PRAM 11 Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cse_pram__embedded_ram11](index.html) module"]
pub struct CSE_PRAM__EMBEDDEDRAM11_SPEC;
impl crate::RegisterSpec for CSE_PRAM__EMBEDDEDRAM11_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cse_pram__embedded_ram11::R](R) reader structure"]
impl crate::Readable for CSE_PRAM__EMBEDDEDRAM11_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cse_pram__embedded_ram11::W](W) writer structure"]
impl crate::Writable for CSE_PRAM__EMBEDDEDRAM11_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets _EmbeddedRAM11 to value 0"]
impl crate::Resettable for CSE_PRAM__EMBEDDEDRAM11_SPEC {
    #[inline(always)]
