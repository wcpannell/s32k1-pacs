#[doc = "Register `C2SC` reader"]
pub struct R(crate::R<C2SC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C2SC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C2SC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C2SC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C2SC` writer"]
pub struct W(crate::W<C2SC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C2SC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C2SC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C2SC_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "DMA Enable\n\nValue on reset: 0"]
...
pub struct C2SC_SPEC;
impl crate::RegisterSpec for C2SC_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c2sc::R](R) reader structure"]
impl crate::Readable for C2SC_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c2sc::W](W) writer structure"]
impl crate::Writable for C2SC_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets C2SC to value 0"]
impl crate::Resettable for C2SC_SPEC {
    #[inline(always)]
