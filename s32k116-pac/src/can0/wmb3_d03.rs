#[doc = "Register `WMB3_D03` reader"]
pub struct R(crate::R<WMB3_D03_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<WMB3_D03_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<WMB3_D03_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<WMB3_D03_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Wake Up Message Buffer Register for Data 0-3\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [wmb3_d03](index.html) module"]
pub struct WMB3_D03_SPEC;
impl crate::RegisterSpec for WMB3_D03_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [wmb3_d03::R](R) reader structure"]
impl crate::Readable for WMB3_D03_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets WMB3_D03 to value 0"]
impl crate::Resettable for WMB3_D03_SPEC {
    #[inline(always)]
