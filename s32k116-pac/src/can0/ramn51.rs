#[doc = "Register `RAMn51` reader"]
pub struct R(crate::R<RAMN51_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RAMN51_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RAMN51_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RAMN51_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RAMn51` writer"]
pub struct W(crate::W<RAMN51_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RAMN51_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RAMN51_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RAMN51_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Embedded RAM\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ramn51](index.html) module"]
pub struct RAMN51_SPEC;
impl crate::RegisterSpec for RAMN51_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ramn51::R](R) reader structure"]
impl crate::Readable for RAMN51_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ramn51::W](W) writer structure"]
impl crate::Writable for RAMN51_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RAMn51 to value 0"]
impl crate::Resettable for RAMN51_SPEC {
    #[inline(always)]
