...
#[doc = "Indicates whether MemManage fault occured during floating-point lazy state preservation\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum MLSPERR_A {
...
#[doc = "Field `MLSPERR` reader - Indicates whether MemManage fault occured during floating-point lazy state preservation"]
...
#[doc = "Field `MLSPERR` writer - Indicates whether MemManage fault occured during floating-point lazy state preservation"]
...
#[doc = "Indicates whether bus fault fault occured during floating-point lazy state preservation\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LSPERR_A {
...
#[doc = "Field `LSPERR` reader - Indicates whether bus fault fault occured during floating-point lazy state preservation"]
...
#[doc = "Field `LSPERR` writer - Indicates whether bus fault fault occured during floating-point lazy state preservation"]
...
#[doc = "Field `INVPC` reader - Invalid PC load UsageFault, caused by an invalid PC load by EXC_RETURN"]
...
#[doc = "Field `INVPC` writer - Invalid PC load UsageFault, caused by an invalid PC load by EXC_RETURN"]
...
#[doc = "No coprocessor UsageFault. The processor does not support coprocessor instructions\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum NOCP_A {
...
#[doc = "Field `NOCP` reader - No coprocessor UsageFault. The processor does not support coprocessor instructions"]
...
#[doc = "Field `NOCP` writer - No coprocessor UsageFault. The processor does not support coprocessor instructions"]
pub struct NOCP_W<'a> {
    w: &'a mut W,
}
impl<'a> NOCP_W<'a> {
...
impl R {
    ...
    #[doc = "Bit 5 - Indicates whether MemManage fault occured during floating-point lazy state preservation"]
    #[inline(always)]
    ...
    #[doc = "Bit 13 - Indicates whether bus fault fault occured during floating-point lazy state preservation"]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - No coprocessor UsageFault. The processor does not support coprocessor instructions"]
    #[inline(always)]
