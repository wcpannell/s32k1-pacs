...
#[doc = "Field `VECTRESET` writer - Reserved for Debug use. This bit reads as 0. When writing to the register you must write 0 to this bit, otherwise behavior is Unpredictable."]
...
#[doc = "System reset request bit is implementation defined\n\nValue on reset: 0"]
...
#[doc = "Field `SYSRESETREQ` writer - System reset request bit is implementation defined"]
...
#[doc = "Data endianness bit is implementation defined\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
#[doc = "Field `ENDIANNESS` reader - Data endianness bit is implementation defined"]
...
impl R {
    ...
    #[doc = "Bit 15 - Data endianness bit is implementation defined"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Reserved for Debug use. This bit reads as 0. When writing to the register you must write 0 to this bit, otherwise behavior is Unpredictable."]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - System reset request bit is implementation defined"]
    #[inline(always)]
