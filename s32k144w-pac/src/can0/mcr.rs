...
impl PNET_EN_R {
    ...
    pub fn variant(&self) -> PNET_EN_A {
        match self.bits {
            false => PNET_EN_A::PN_DISABLED,
            true => PNET_EN_A::PN_ENABLED,
        }
    }
    #[doc = "Checks if the value of the field is `PN_DISABLED`"]
    #[inline(always)]
    pub fn is_pn_disabled(&self) -> bool {
        **self == PNET_EN_A::PN_DISABLED
    }
    #[doc = "Checks if the value of the field is `PN_ENABLED`"]
    #[inline(always)]
    pub fn is_pn_enabled(&self) -> bool {
        **self == PNET_EN_A::PN_ENABLED
    }
}
...
impl<'a> PNET_EN_W<'a> {
    ...
    #[inline(always)]
    pub fn pn_disabled(self) -> &'a mut W {
        self.variant(PNET_EN_A::PN_DISABLED)
    }
    #[doc = "Pretended Networking mode is enabled."]
    #[inline(always)]
    pub fn pn_enabled(self) -> &'a mut W {
        self.variant(PNET_EN_A::PN_ENABLED)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
