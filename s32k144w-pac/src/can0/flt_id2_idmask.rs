...
impl RTR_MSK_R {
    ...
    pub fn variant(&self) -> RTR_MSK_A {
        match self.bits {
            false => RTR_MSK_A::FRAME_TYPE_NO,
            true => RTR_MSK_A::FRAME_TYPE_YES,
        }
    }
    #[doc = "Checks if the value of the field is `FRAME_TYPE_NO`"]
    #[inline(always)]
    pub fn is_frame_type_no(&self) -> bool {
        **self == RTR_MSK_A::FRAME_TYPE_NO
    }
    #[doc = "Checks if the value of the field is `FRAME_TYPE_YES`"]
    #[inline(always)]
    pub fn is_frame_type_yes(&self) -> bool {
        **self == RTR_MSK_A::FRAME_TYPE_YES
    }
}
...
impl<'a> RTR_MSK_W<'a> {
    ...
    #[inline(always)]
    pub fn frame_type_no(self) -> &'a mut W {
        self.variant(RTR_MSK_A::FRAME_TYPE_NO)
    }
    #[doc = "The corresponding bit in the filter is checked"]
    #[inline(always)]
    pub fn frame_type_yes(self) -> &'a mut W {
        self.variant(RTR_MSK_A::FRAME_TYPE_YES)
    }
...
impl IDE_MSK_R {
    ...
    pub fn variant(&self) -> IDE_MSK_A {
        match self.bits {
            false => IDE_MSK_A::FRAME_FORMAT_NO,
            true => IDE_MSK_A::FRAME_FORMAT_YES,
        }
    }
    #[doc = "Checks if the value of the field is `FRAME_FORMAT_NO`"]
    #[inline(always)]
    pub fn is_frame_format_no(&self) -> bool {
        **self == IDE_MSK_A::FRAME_FORMAT_NO
    }
    #[doc = "Checks if the value of the field is `FRAME_FORMAT_YES`"]
    #[inline(always)]
    pub fn is_frame_format_yes(&self) -> bool {
        **self == IDE_MSK_A::FRAME_FORMAT_YES
    }
}
...
impl<'a> IDE_MSK_W<'a> {
    ...
    #[doc = "The corresponding bit in the filter is \"don't care\""]
    #[inline(always)]
    pub fn frame_format_no(self) -> &'a mut W {
        self.variant(IDE_MSK_A::FRAME_FORMAT_NO)
    }
    #[doc = "The corresponding bit in the filter is checked"]
    #[inline(always)]
    pub fn frame_format_yes(self) -> &'a mut W {
        self.variant(IDE_MSK_A::FRAME_FORMAT_YES)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
