...
impl PEFSIZE_R {
    ...
    pub fn variant(&self) -> Option<PEFSIZE_A> {
        match self.bits {
            0 => Some(PEFSIZE_A::PEFSIZE_0),
            1 => Some(PEFSIZE_A::PEFSIZE_1),
            2 => Some(PEFSIZE_A::PEFSIZE_2),
            3 => Some(PEFSIZE_A::PEFSIZE_3),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PEFSIZE_0`"]
    #[inline(always)]
    pub fn is_pefsize_0(&self) -> bool {
        **self == PEFSIZE_A::PEFSIZE_0
    }
    #[doc = "Checks if the value of the field is `PEFSIZE_1`"]
    #[inline(always)]
    pub fn is_pefsize_1(&self) -> bool {
        **self == PEFSIZE_A::PEFSIZE_1
    }
    #[doc = "Checks if the value of the field is `PEFSIZE_2`"]
    #[inline(always)]
    pub fn is_pefsize_2(&self) -> bool {
        **self == PEFSIZE_A::PEFSIZE_2
    }
    #[doc = "Checks if the value of the field is `PEFSIZE_3`"]
    #[inline(always)]
    pub fn is_pefsize_3(&self) -> bool {
        **self == PEFSIZE_A::PEFSIZE_3
    }
}
