...
impl EHSRUN_R {
    ...
    pub fn variant(&self) -> EHSRUN_A {
        match self.bits {
            false => EHSRUN_A::EHSRUN_0,
            true => EHSRUN_A::EHSRUN_1,
        }
    }
    #[doc = "Checks if the value of the field is `EHSRUN_0`"]
    #[inline(always)]
    pub fn is_ehsrun_0(&self) -> bool {
        **self == EHSRUN_A::EHSRUN_0
    }
    #[doc = "Checks if the value of the field is `EHSRUN_1`"]
    #[inline(always)]
    pub fn is_ehsrun_1(&self) -> bool {
        **self == EHSRUN_A::EHSRUN_1
    }
}
...
impl ELLS_R {
    ...
    #[doc = "Checks if the value of the field is `ELLS_0`"]
    #[inline(always)]
    pub fn is_ells_0(&self) -> bool {
        **self == ELLS_A::ELLS_0
    }
    #[doc = "Checks if the value of the field is `ELLS_1`"]
    #[inline(always)]
    pub fn is_ells_1(&self) -> bool {
        **self == ELLS_A::ELLS_1
    }
}
...
impl ELLS2_R {
    ...
    pub fn variant(&self) -> ELLS2_A {
        match self.bits {
            false => ELLS2_A::ELLS2_0,
            true => ELLS2_A::ELLS2_1,
        }
    }
    #[doc = "Checks if the value of the field is `ELLS2_0`"]
    #[inline(always)]
    pub fn is_ells2_0(&self) -> bool {
        **self == ELLS2_A::ELLS2_0
    }
    #[doc = "Checks if the value of the field is `ELLS2_1`"]
    #[inline(always)]
    pub fn is_ells2_1(&self) -> bool {
        **self == ELLS2_A::ELLS2_1
    }
}
...
impl EVLLS0_R {
    ...
    pub fn variant(&self) -> EVLLS0_A {
        match self.bits {
            false => EVLLS0_A::EVLLS0_0,
            true => EVLLS0_A::EVLLS0_1,
        }
    }
    #[doc = "Checks if the value of the field is `EVLLS0_0`"]
    #[inline(always)]
    pub fn is_evlls0_0(&self) -> bool {
        **self == EVLLS0_A::EVLLS0_0
    }
    #[doc = "Checks if the value of the field is `EVLLS0_1`"]
    #[inline(always)]
    pub fn is_evlls0_1(&self) -> bool {
        **self == EVLLS0_A::EVLLS0_1
    }
}
