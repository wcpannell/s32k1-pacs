...
impl MATCFG_R {
    ...
    pub fn variant(&self) -> Option<MATCFG_A> {
        match self.bits {
            0 => Some(MATCFG_A::MATCFG_0),
            2 => Some(MATCFG_A::MATCFG_2),
            3 => Some(MATCFG_A::MATCFG_3),
            4 => Some(MATCFG_A::MATCFG_4),
            5 => Some(MATCFG_A::MATCFG_5),
            6 => Some(MATCFG_A::MATCFG_6),
            7 => Some(MATCFG_A::MATCFG_7),
            _ => None,
        }
    }
