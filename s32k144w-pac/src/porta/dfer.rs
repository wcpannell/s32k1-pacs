...
impl DFE_R {
    ...
    #[doc = "Checks if the value of the field is `DFE_0`"]
    #[inline(always)]
    pub fn is_dfe_0(&self) -> bool {
        **self == DFE_A::DFE_0
    }
    #[doc = "Checks if the value of the field is `DFE_1`"]
    #[inline(always)]
    pub fn is_dfe_1(&self) -> bool {
        **self == DFE_A::DFE_1
    }
}
...
impl<'a> DFE_W<'a> {
    ...
    #[inline(always)]
    pub fn dfe_0(self) -> &'a mut W {
        self.variant(DFE_A::DFE_0)
    }
    #[doc = "Digital filter is enabled on the corresponding pin, if the pin is configured as a digital input."]
    #[inline(always)]
    pub fn dfe_1(self) -> &'a mut W {
        self.variant(DFE_A::DFE_1)
    }
