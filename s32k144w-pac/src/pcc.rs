...
pub struct RegisterBlock {
    _reserved0: [u8; 0x80],
    #[doc = "0x80 - PCC FTFM Register"]
    pub pcc_ftfm: crate::Reg<pcc_ftfm::PCC_FTFM_SPEC>,
...
#[doc = "PCC_FTFM register accessor: an alias for `Reg<PCC_FTFM_SPEC>`"]
pub type PCC_FTFM = crate::Reg<pcc_ftfm::PCC_FTFM_SPEC>;
