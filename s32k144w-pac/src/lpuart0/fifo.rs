...
#[doc = "Field `RXFLUSH` reader - Receive FIFO/Buffer Flush"]
pub struct RXFLUSH_R(crate::FieldReader<bool, RXFLUSH_A>);
impl RXFLUSH_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        RXFLUSH_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for RXFLUSH_R {
    type Target = crate::FieldReader<bool, RXFLUSH_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
#[doc = "Field `TXFLUSH` reader - Transmit FIFO/Buffer Flush"]
pub struct TXFLUSH_R(crate::FieldReader<bool, TXFLUSH_A>);
impl TXFLUSH_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        TXFLUSH_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for TXFLUSH_R {
    type Target = crate::FieldReader<bool, TXFLUSH_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
