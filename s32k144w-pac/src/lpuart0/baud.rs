...
pub struct RIDMAE_R(crate::FieldReader<bool, RIDMAE_A>);
impl RIDMAE_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        RIDMAE_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for RIDMAE_R {
    type Target = crate::FieldReader<bool, RIDMAE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl OSR_R {
    ...
    pub fn variant(&self) -> Option<OSR_A> {
        match self.bits {
            ...
            8 => Some(OSR_A::OSR_8),
            9 => Some(OSR_A::OSR_9),
            10 => Some(OSR_A::OSR_10),
            11 => Some(OSR_A::OSR_11),
            12 => Some(OSR_A::OSR_12),
            13 => Some(OSR_A::OSR_13),
            14 => Some(OSR_A::OSR_14),
            15 => Some(OSR_A::OSR_15),
            16 => Some(OSR_A::OSR_16),
            17 => Some(OSR_A::OSR_17),
            18 => Some(OSR_A::OSR_18),
            19 => Some(OSR_A::OSR_19),
            20 => Some(OSR_A::OSR_20),
            21 => Some(OSR_A::OSR_21),
            22 => Some(OSR_A::OSR_22),
            23 => Some(OSR_A::OSR_23),
            24 => Some(OSR_A::OSR_24),
            25 => Some(OSR_A::OSR_25),
            26 => Some(OSR_A::OSR_26),
            27 => Some(OSR_A::OSR_27),
            28 => Some(OSR_A::OSR_28),
            29 => Some(OSR_A::OSR_29),
            30 => Some(OSR_A::OSR_30),
            31 => Some(OSR_A::OSR_31),
            _ => None,
        }
    }
