...
pub struct NCE1_R(crate::FieldReader<bool, NCE1_A>);
impl NCE1_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        NCE1_R(crate::FieldReader::new(bits))
    }
    ...
    #[doc = "Checks if the value of the field is `NCE1_0`"]
    #[inline(always)]
    pub fn is_nce1_0(&self) -> bool {
        **self == NCE1_A::NCE1_0
    }
    #[doc = "Checks if the value of the field is `NCE1_1`"]
    #[inline(always)]
    pub fn is_nce1_1(&self) -> bool {
        **self == NCE1_A::NCE1_1
    }
}
impl core::ops::Deref for NCE1_R {
    type Target = crate::FieldReader<bool, NCE1_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> NCE1_W<'a> {
    ...
    #[inline(always)]
    pub fn nce1_0(self) -> &'a mut W {
        self.variant(NCE1_A::NCE1_0)
    }
    #[doc = "Non-correctable error event on Memory 1 detected."]
    #[inline(always)]
    pub fn nce1_1(self) -> &'a mut W {
        self.variant(NCE1_A::NCE1_1)
    }
...
pub struct SBC1_R(crate::FieldReader<bool, SBC1_A>);
impl SBC1_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        SBC1_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    ...
    #[doc = "Checks if the value of the field is `SBC1_0`"]
    #[inline(always)]
    pub fn is_sbc1_0(&self) -> bool {
        **self == SBC1_A::SBC1_0
    }
    #[doc = "Checks if the value of the field is `SBC1_1`"]
    #[inline(always)]
    pub fn is_sbc1_1(&self) -> bool {
        **self == SBC1_A::SBC1_1
    }
}
impl core::ops::Deref for SBC1_R {
    type Target = crate::FieldReader<bool, SBC1_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> SBC1_W<'a> {
    ...
    #[inline(always)]
    pub fn sbc1_0(self) -> &'a mut W {
        self.variant(SBC1_A::SBC1_0)
    }
    #[doc = "Single-bit correction event on Memory 1 detected."]
    #[inline(always)]
    pub fn sbc1_1(self) -> &'a mut W {
        self.variant(SBC1_A::SBC1_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl NCE0_R {
    ...
    #[doc = "Checks if the value of the field is `NCE0_0`"]
    #[inline(always)]
    pub fn is_nce0_0(&self) -> bool {
        **self == NCE0_A::NCE0_0
    }
    #[doc = "Checks if the value of the field is `NCE0_1`"]
    #[inline(always)]
    pub fn is_nce0_1(&self) -> bool {
        **self == NCE0_A::NCE0_1
    }
}
...
impl<'a> NCE0_W<'a> {
    ...
    #[inline(always)]
    pub fn nce0_0(self) -> &'a mut W {
        self.variant(NCE0_A::NCE0_0)
    }
    #[doc = "Non-correctable error event on Memory 0 detected."]
    #[inline(always)]
    pub fn nce0_1(self) -> &'a mut W {
        self.variant(NCE0_A::NCE0_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl SBC0_R {
    ...
    #[doc = "Checks if the value of the field is `SBC0_0`"]
    #[inline(always)]
    pub fn is_sbc0_0(&self) -> bool {
        **self == SBC0_A::SBC0_0
    }
    #[doc = "Checks if the value of the field is `SBC0_1`"]
    #[inline(always)]
    pub fn is_sbc0_1(&self) -> bool {
        **self == SBC0_A::SBC0_1
    }
}
...
impl<'a> SBC0_W<'a> {
    ...
    #[inline(always)]
    pub fn sbc0_0(self) -> &'a mut W {
        self.variant(SBC0_A::SBC0_0)
    }
    #[doc = "Single-bit correction event on Memory 0 detected."]
    #[inline(always)]
    pub fn sbc0_1(self) -> &'a mut W {
        self.variant(SBC0_A::SBC0_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
