...
impl ENCIE1_R {
    ...
    pub fn variant(&self) -> ENCIE1_A {
        match self.bits {
            false => ENCIE1_A::ENCIE1_0,
            true => ENCIE1_A::ENCIE1_1,
        }
    }
    #[doc = "Checks if the value of the field is `ENCIE1_0`"]
    #[inline(always)]
    pub fn is_encie1_0(&self) -> bool {
        **self == ENCIE1_A::ENCIE1_0
    }
    #[doc = "Checks if the value of the field is `ENCIE1_1`"]
    #[inline(always)]
    pub fn is_encie1_1(&self) -> bool {
        **self == ENCIE1_A::ENCIE1_1
    }
}
...
impl<'a> ENCIE1_W<'a> {
    ...
    #[inline(always)]
    pub fn encie1_0(self) -> &'a mut W {
        self.variant(ENCIE1_A::ENCIE1_0)
    }
    #[doc = "Interrupt notification of Memory 1 non-correctable error events is enabled."]
    #[inline(always)]
    pub fn encie1_1(self) -> &'a mut W {
        self.variant(ENCIE1_A::ENCIE1_1)
    }
...
impl ESCIE1_R {
    ...
    pub fn variant(&self) -> ESCIE1_A {
        match self.bits {
            false => ESCIE1_A::ESCIE1_0,
            true => ESCIE1_A::ESCIE1_1,
        }
    }
    #[doc = "Checks if the value of the field is `ESCIE1_0`"]
    #[inline(always)]
    pub fn is_escie1_0(&self) -> bool {
        **self == ESCIE1_A::ESCIE1_0
    }
    #[doc = "Checks if the value of the field is `ESCIE1_1`"]
    #[inline(always)]
    pub fn is_escie1_1(&self) -> bool {
        **self == ESCIE1_A::ESCIE1_1
    }
}
...
impl<'a> ESCIE1_W<'a> {
    ...
    #[inline(always)]
    pub fn escie1_0(self) -> &'a mut W {
        self.variant(ESCIE1_A::ESCIE1_0)
    }
    #[doc = "Interrupt notification of Memory 1 single-bit correction events is enabled."]
    #[inline(always)]
    pub fn escie1_1(self) -> &'a mut W {
        self.variant(ESCIE1_A::ESCIE1_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl ENCIE0_R {
    ...
    pub fn variant(&self) -> ENCIE0_A {
        match self.bits {
            false => ENCIE0_A::ENCIE0_0,
            true => ENCIE0_A::ENCIE0_1,
        }
    }
    #[doc = "Checks if the value of the field is `ENCIE0_0`"]
    #[inline(always)]
    pub fn is_encie0_0(&self) -> bool {
        **self == ENCIE0_A::ENCIE0_0
    }
    #[doc = "Checks if the value of the field is `ENCIE0_1`"]
    #[inline(always)]
    pub fn is_encie0_1(&self) -> bool {
        **self == ENCIE0_A::ENCIE0_1
    }
}
...
impl<'a> ENCIE0_W<'a> {
    ...
    #[inline(always)]
    pub fn encie0_0(self) -> &'a mut W {
        self.variant(ENCIE0_A::ENCIE0_0)
    }
    #[doc = "Interrupt notification of Memory 0 non-correctable error events is enabled."]
    #[inline(always)]
    pub fn encie0_1(self) -> &'a mut W {
        self.variant(ENCIE0_A::ENCIE0_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl ESCIE0_R {
    ...
    pub fn variant(&self) -> ESCIE0_A {
        match self.bits {
            false => ESCIE0_A::ESCIE0_0,
            true => ESCIE0_A::ESCIE0_1,
        }
    }
    #[doc = "Checks if the value of the field is `ESCIE0_0`"]
    #[inline(always)]
    pub fn is_escie0_0(&self) -> bool {
        **self == ESCIE0_A::ESCIE0_0
    }
    #[doc = "Checks if the value of the field is `ESCIE0_1`"]
    #[inline(always)]
    pub fn is_escie0_1(&self) -> bool {
        **self == ESCIE0_A::ESCIE0_1
    }
}
...
impl<'a> ESCIE0_W<'a> {
    ...
    #[inline(always)]
    pub fn escie0_0(self) -> &'a mut W {
        self.variant(ESCIE0_A::ESCIE0_0)
    }
    #[doc = "Interrupt notification of Memory 0 single-bit correction events is enabled."]
    #[inline(always)]
    pub fn escie0_1(self) -> &'a mut W {
        self.variant(ESCIE0_A::ESCIE0_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
