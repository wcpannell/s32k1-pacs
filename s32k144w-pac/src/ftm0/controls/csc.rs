...
impl ICRST_R {
    ...
    pub fn variant(&self) -> ICRST_A {
        match self.bits {
            false => ICRST_A::ICRST_0,
            true => ICRST_A::ICRST_1,
        }
    }
    #[doc = "Checks if the value of the field is `ICRST_0`"]
    #[inline(always)]
    pub fn is_icrst_0(&self) -> bool {
        **self == ICRST_A::ICRST_0
    }
    #[doc = "Checks if the value of the field is `ICRST_1`"]
    #[inline(always)]
    pub fn is_icrst_1(&self) -> bool {
        **self == ICRST_A::ICRST_1
    }
}
...
impl<'a> ICRST_W<'a> {
    ...
    #[inline(always)]
    pub fn icrst_0(self) -> &'a mut W {
        self.variant(ICRST_A::ICRST_0)
    }
    #[doc = "FTM counter is reset when the selected channel (n) input event is detected."]
    #[inline(always)]
    pub fn icrst_1(self) -> &'a mut W {
        self.variant(ICRST_A::ICRST_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
#[doc = "Field `CHF` writer - Channel (n) Flag"]
pub struct CHF_W<'a> {
    w: &'a mut W,
}
impl<'a> CHF_W<'a> {
...
impl TRIGMODE_R {
    ...
    pub fn variant(&self) -> TRIGMODE_A {
        match self.bits {
            false => TRIGMODE_A::TRIGMODE_0,
            true => TRIGMODE_A::TRIGMODE_1,
        }
    }
    #[doc = "Checks if the value of the field is `TRIGMODE_0`"]
    #[inline(always)]
    pub fn is_trigmode_0(&self) -> bool {
        **self == TRIGMODE_A::TRIGMODE_0
    }
    #[doc = "Checks if the value of the field is `TRIGMODE_1`"]
    #[inline(always)]
    pub fn is_trigmode_1(&self) -> bool {
        **self == TRIGMODE_A::TRIGMODE_1
    }
}
...
impl<'a> TRIGMODE_W<'a> {
    ...
    #[inline(always)]
    pub fn trigmode_0(self) -> &'a mut W {
        self.variant(TRIGMODE_A::TRIGMODE_0)
    }
    ...
    #[inline(always)]
    pub fn trigmode_1(self) -> &'a mut W {
        self.variant(TRIGMODE_A::TRIGMODE_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl CHIS_R {
    ...
    #[doc = "Checks if the value of the field is `CHIS_0`"]
    #[inline(always)]
    pub fn is_chis_0(&self) -> bool {
        **self == CHIS_A::CHIS_0
    }
    #[doc = "Checks if the value of the field is `CHIS_1`"]
    #[inline(always)]
    pub fn is_chis_1(&self) -> bool {
        **self == CHIS_A::CHIS_1
    }
}
...
impl CHOV_R {
    ...
    #[doc = "Checks if the value of the field is `CHOV_0`"]
    #[inline(always)]
    pub fn is_chov_0(&self) -> bool {
        **self == CHOV_A::CHOV_0
    }
    #[doc = "Checks if the value of the field is `CHOV_1`"]
    #[inline(always)]
    pub fn is_chov_1(&self) -> bool {
        **self == CHOV_A::CHOV_1
    }
}
...
#[doc = "`reset()` method sets CSC to value 0"]
