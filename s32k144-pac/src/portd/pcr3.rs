...
pub struct R(crate::R<PCR3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PCR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PCR3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PCR3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PCR3` writer"]
pub struct W(crate::W<PCR3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PCR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PCR3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PCR3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Pull Select\n\nValue on reset: 0"]
...
#[doc = "`reset()` method sets PCR3 to value 0"]
