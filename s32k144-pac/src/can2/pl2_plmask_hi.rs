...
pub struct R(crate::R<PL2_PLMASK_HI_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PL2_PLMASK_HI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PL2_PLMASK_HI_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PL2_PLMASK_HI_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PL2_PLMASK_HI` writer"]
pub struct W(crate::W<PL2_PLMASK_HI_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PL2_PLMASK_HI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PL2_PLMASK_HI_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PL2_PLMASK_HI_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `Data_byte_7` reader - Payload Filter 2 high order bits / Payload Mask high order bits for Pretended Networking payload filtering corresponding to the data byte 7."]
...
#[doc = "Field `Data_byte_7` writer - Payload Filter 2 high order bits / Payload Mask high order bits for Pretended Networking payload filtering corresponding to the data byte 7."]
...
#[doc = "Field `Data_byte_6` reader - Payload Filter 2 high order bits / Payload Mask high order bits for Pretended Networking payload filtering corresponding to the data byte 6."]
...
#[doc = "Field `Data_byte_6` writer - Payload Filter 2 high order bits / Payload Mask high order bits for Pretended Networking payload filtering corresponding to the data byte 6."]
...
#[doc = "Field `Data_byte_5` reader - Payload Filter 2 high order bits / Payload Mask high order bits for Pretended Networking payload filtering corresponding to the data byte 5."]
...
#[doc = "Field `Data_byte_5` writer - Payload Filter 2 high order bits / Payload Mask high order bits for Pretended Networking payload filtering corresponding to the data byte 5."]
...
#[doc = "Field `Data_byte_4` reader - Payload Filter 2 high order bits / Payload Mask high order bits for Pretended Networking payload filtering corresponding to the data byte 4."]
...
#[doc = "Field `Data_byte_4` writer - Payload Filter 2 high order bits / Payload Mask high order bits for Pretended Networking payload filtering corresponding to the data byte 4."]
