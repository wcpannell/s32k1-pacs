...
#[doc = "Register `C3V` writer"]
pub struct W(crate::W<C3V_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C3V_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C3V_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C3V_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`write(|w| ..)` method takes [c3v::W](W) writer structure"]
impl crate::Writable for C3V_SPEC {
    type Writer = W;
}
