...
#[doc = "Register `C0V` writer"]
pub struct W(crate::W<C0V_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C0V_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C0V_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C0V_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`write(|w| ..)` method takes [c0v::W](W) writer structure"]
impl crate::Writable for C0V_SPEC {
    type Writer = W;
}
