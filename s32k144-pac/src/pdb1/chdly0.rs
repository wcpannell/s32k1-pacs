...
pub struct R(crate::R<CHDLY0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CHDLY0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CHDLY0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CHDLY0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH%sDLY0` writer"]
pub struct W(crate::W<CHDLY0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CHDLY0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CHDLY0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CHDLY0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel n Delay 0 register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [chdly0](index.html) module"]
pub struct CHDLY0_SPEC;
impl crate::RegisterSpec for CHDLY0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [chdly0::R](R) reader structure"]
impl crate::Readable for CHDLY0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [chdly0::W](W) writer structure"]
impl crate::Writable for CHDLY0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CH%sDLY0 to value 0"]
impl crate::Resettable for CHDLY0_SPEC {
    #[inline(always)]
