...
pub struct R(crate::R<PCR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PCR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PCR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PCR1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PCR1` writer"]
pub struct W(crate::W<PCR1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PCR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PCR1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PCR1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Pull Select\n\nValue on reset: 0"]
...
#[doc = "Pin Control Register n\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pcr1](index.html) module"]
pub struct PCR1_SPEC;
impl crate::RegisterSpec for PCR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pcr1::R](R) reader structure"]
impl crate::Readable for PCR1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pcr1::W](W) writer structure"]
impl crate::Writable for PCR1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PCR1 to value 0"]
impl crate::Resettable for PCR1_SPEC {
    #[inline(always)]
