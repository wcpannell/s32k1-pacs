#[doc = "Register `PCR12` reader"]
pub struct R(crate::R<PCR12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PCR12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PCR12_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PCR12_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PCR12` writer"]
pub struct W(crate::W<PCR12_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PCR12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PCR12_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PCR12_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Pull Select\n\nValue on reset: 0"]
...
pub struct PCR12_SPEC;
impl crate::RegisterSpec for PCR12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pcr12::R](R) reader structure"]
impl crate::Readable for PCR12_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pcr12::W](W) writer structure"]
impl crate::Writable for PCR12_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PCR12 to value 0"]
impl crate::Resettable for PCR12_SPEC {
    #[inline(always)]
