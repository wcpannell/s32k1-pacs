#[doc = "Register `TCD4_ATTR` reader"]
pub struct R(crate::R<TCD4_ATTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TCD4_ATTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TCD4_ATTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TCD4_ATTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TCD4_ATTR` writer"]
pub struct W(crate::W<TCD4_ATTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TCD4_ATTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TCD4_ATTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TCD4_ATTR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "TCD Transfer Attributes\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tcd4_attr](index.html) module"]
pub struct TCD4_ATTR_SPEC;
impl crate::RegisterSpec for TCD4_ATTR_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [tcd4_attr::R](R) reader structure"]
impl crate::Readable for TCD4_ATTR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tcd4_attr::W](W) writer structure"]
impl crate::Writable for TCD4_ATTR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TCD4_ATTR to value 0"]
impl crate::Resettable for TCD4_ATTR_SPEC {
    #[inline(always)]
