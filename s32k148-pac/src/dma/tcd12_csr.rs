#[doc = "Register `TCD12_CSR` reader"]
pub struct R(crate::R<TCD12_CSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TCD12_CSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TCD12_CSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TCD12_CSR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TCD12_CSR` writer"]
pub struct W(crate::W<TCD12_CSR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TCD12_CSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TCD12_CSR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TCD12_CSR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Channel Start\n\nValue on reset: 0"]
...
#[doc = "TCD Control and Status\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tcd12_csr](index.html) module"]
pub struct TCD12_CSR_SPEC;
impl crate::RegisterSpec for TCD12_CSR_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [tcd12_csr::R](R) reader structure"]
impl crate::Readable for TCD12_CSR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tcd12_csr::W](W) writer structure"]
impl crate::Writable for TCD12_CSR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TCD12_CSR to value 0"]
impl crate::Resettable for TCD12_CSR_SPEC {
    #[inline(always)]
