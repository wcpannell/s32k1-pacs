#[doc = "Register `DCHPRI6` reader"]
pub struct R(crate::R<DCHPRI6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCHPRI6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCHPRI6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCHPRI6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCHPRI6` writer"]
pub struct W(crate::W<DCHPRI6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCHPRI6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCHPRI6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCHPRI6_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel n Priority Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dchpri6](index.html) module"]
pub struct DCHPRI6_SPEC;
impl crate::RegisterSpec for DCHPRI6_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [dchpri6::R](R) reader structure"]
impl crate::Readable for DCHPRI6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dchpri6::W](W) writer structure"]
impl crate::Writable for DCHPRI6_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DCHPRI6 to value 0x06"]
impl crate::Resettable for DCHPRI6_SPEC {
    #[inline(always)]
