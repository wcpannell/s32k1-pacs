#[doc = "Register `DCHPRI5` reader"]
pub struct R(crate::R<DCHPRI5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCHPRI5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCHPRI5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCHPRI5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCHPRI5` writer"]
pub struct W(crate::W<DCHPRI5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCHPRI5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCHPRI5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCHPRI5_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel n Priority Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dchpri5](index.html) module"]
pub struct DCHPRI5_SPEC;
impl crate::RegisterSpec for DCHPRI5_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [dchpri5::R](R) reader structure"]
impl crate::Readable for DCHPRI5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dchpri5::W](W) writer structure"]
impl crate::Writable for DCHPRI5_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DCHPRI5 to value 0x05"]
impl crate::Resettable for DCHPRI5_SPEC {
    #[inline(always)]
