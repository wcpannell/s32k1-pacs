...
pub struct RegisterBlock {
    ...
    #[doc = "0x88 - Channel n Control register 1"]
    pub ch3c1: crate::Reg<chc1::CHC1_SPEC>,
    #[doc = "0x8c - Channel n Status register"]
    pub ch3s: crate::Reg<chs::CHS_SPEC>,
    #[doc = "0x90 - Channel n Delay 0 register"]
    pub ch3dly0: crate::Reg<chdly0::CHDLY0_SPEC>,
    #[doc = "0x94 - Channel n Delay 1 register"]
    pub ch3dly1: crate::Reg<chdly1::CHDLY1_SPEC>,
    #[doc = "0x98 - Channel n Delay 2 register"]
    pub ch3dly2: crate::Reg<chdly2::CHDLY2_SPEC>,
    #[doc = "0x9c - Channel n Delay 3 register"]
    pub ch3dly3: crate::Reg<chdly3::CHDLY3_SPEC>,
    #[doc = "0xa0 - Channel n Delay 4 register"]
    pub ch3dly4: crate::Reg<chdly4::CHDLY4_SPEC>,
    #[doc = "0xa4 - Channel n Delay 5 register"]
    pub ch3dly5: crate::Reg<chdly5::CHDLY5_SPEC>,
    #[doc = "0xa8 - Channel n Delay 6 register"]
    pub ch3dly6: crate::Reg<chdly6::CHDLY6_SPEC>,
    #[doc = "0xac - Channel n Delay 7 register"]
    pub ch3dly7: crate::Reg<chdly7::CHDLY7_SPEC>,
    _reserved44: [u8; 0xe0],
    #[doc = "0x190 - Pulse-Out n Enable register"]
    pub poen: crate::Reg<poen::POEN_SPEC>,
    _reserved_45_dly1: [u8; 0x04],
}
impl RegisterBlock {
    #[doc = "0x194 - PDB1_DLY2 register."]
    #[inline(always)]
    pub fn pdb1_dly2(&self) -> &crate::Reg<pdb1_dly2::PDB1_DLY2_SPEC> {
        unsafe {
            &*(((self as *const Self) as *const u8).add(404usize)
                as *const crate::Reg<pdb1_dly2::PDB1_DLY2_SPEC>)
        }
    }
    #[doc = "0x194 - Pulse-Out n Delay register"]
    #[inline(always)]
    pub fn pdb1_podly(&self) -> &crate::Reg<pdb1_podly::PDB1_PODLY_SPEC> {
        unsafe {
            &*(((self as *const Self) as *const u8).add(404usize)
                as *const crate::Reg<pdb1_podly::PDB1_PODLY_SPEC>)
        }
    }
    #[doc = "0x196 - PDB1_DLY1 register."]
    #[inline(always)]
...
pub mod poen;
#[doc = "PDB1_PODLY register accessor: an alias for `Reg<PDB1_PODLY_SPEC>`"]
pub type PDB1_PODLY = crate::Reg<pdb1_podly::PDB1_PODLY_SPEC>;
#[doc = "Pulse-Out n Delay register"]
pub mod pdb1_podly;
#[doc = "PDB1_DLY2 register accessor: an alias for `Reg<PDB1_DLY2_SPEC>`"]
pub type PDB1_DLY2 = crate::Reg<pdb1_dly2::PDB1_DLY2_SPEC>;
#[doc = "PDB1_DLY2 register."]
pub mod pdb1_dly2;
