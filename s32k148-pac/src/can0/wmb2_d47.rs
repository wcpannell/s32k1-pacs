#[doc = "Register `WMB2_D47` reader"]
pub struct R(crate::R<WMB2_D47_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<WMB2_D47_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<WMB2_D47_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<WMB2_D47_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Wake Up Message Buffer Register Data 4-7\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [wmb2_d47](index.html) module"]
pub struct WMB2_D47_SPEC;
impl crate::RegisterSpec for WMB2_D47_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [wmb2_d47::R](R) reader structure"]
impl crate::Readable for WMB2_D47_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets WMB2_D47 to value 0"]
impl crate::Resettable for WMB2_D47_SPEC {
    #[inline(always)]
