#[doc = "Register `WMB0_CS` reader"]
pub struct R(crate::R<WMB0_CS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<WMB0_CS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<WMB0_CS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<WMB0_CS_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Wake Up Message Buffer Register for C/S\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [wmb0_cs](index.html) module"]
pub struct WMB0_CS_SPEC;
impl crate::RegisterSpec for WMB0_CS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [wmb0_cs::R](R) reader structure"]
impl crate::Readable for WMB0_CS_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets WMB0_CS to value 0"]
impl crate::Resettable for WMB0_CS_SPEC {
    #[inline(always)]
