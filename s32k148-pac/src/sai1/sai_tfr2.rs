#[doc = "Register `SAI_TFR2` reader"]
pub struct R(crate::R<SAI_TFR2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SAI_TFR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SAI_TFR2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SAI_TFR2_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "SAI Transmit FIFO Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sai_tfr2](index.html) module"]
pub struct SAI_TFR2_SPEC;
impl crate::RegisterSpec for SAI_TFR2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sai_tfr2::R](R) reader structure"]
impl crate::Readable for SAI_TFR2_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets SAI_TFR2 to value 0"]
impl crate::Resettable for SAI_TFR2_SPEC {
    #[inline(always)]
