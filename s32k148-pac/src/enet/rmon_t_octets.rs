...
#[doc = "Field `TXOCTS` reader - Number of transmit octets"]
pub struct TXOCTS_R(crate::FieldReader<u32, u32>);
impl TXOCTS_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        TXOCTS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TXOCTS_R {
