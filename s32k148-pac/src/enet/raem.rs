...
pub struct RX_ALMOST_EMPTY_R(crate::FieldReader<u8, u8>);
impl RX_ALMOST_EMPTY_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        RX_ALMOST_EMPTY_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RX_ALMOST_EMPTY_R {
