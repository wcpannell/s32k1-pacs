...
#[doc = "Field `FTM6SYNCBIT` reader - FTM6 Sync Bit"]
pub struct FTM6SYNCBIT_R(crate::FieldReader<bool, bool>);
impl FTM6SYNCBIT_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        FTM6SYNCBIT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FTM6SYNCBIT_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `FTM6SYNCBIT` writer - FTM6 Sync Bit"]
pub struct FTM6SYNCBIT_W<'a> {
    w: &'a mut W,
}
impl<'a> FTM6SYNCBIT_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Field `FTM7SYNCBIT` reader - FTM7 Sync Bit"]
pub struct FTM7SYNCBIT_R(crate::FieldReader<bool, bool>);
impl FTM7SYNCBIT_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        FTM7SYNCBIT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FTM7SYNCBIT_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `FTM7SYNCBIT` writer - FTM7 Sync Bit"]
pub struct FTM7SYNCBIT_W<'a> {
    w: &'a mut W,
}
impl<'a> FTM7SYNCBIT_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    #[doc = "Bit 13 - FTM6 Sync Bit"]
    #[inline(always)]
    pub fn ftm6syncbit(&self) -> FTM6SYNCBIT_R {
        FTM6SYNCBIT_R::new(((self.bits >> 13) & 0x01) != 0)
    }
    #[doc = "Bit 14 - FTM7 Sync Bit"]
    #[inline(always)]
    pub fn ftm7syncbit(&self) -> FTM7SYNCBIT_R {
        FTM7SYNCBIT_R::new(((self.bits >> 14) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 13 - FTM6 Sync Bit"]
    #[inline(always)]
    pub fn ftm6syncbit(&mut self) -> FTM6SYNCBIT_W {
        FTM6SYNCBIT_W { w: self }
    }
    #[doc = "Bit 14 - FTM7 Sync Bit"]
    #[inline(always)]
    pub fn ftm7syncbit(&mut self) -> FTM7SYNCBIT_W {
        FTM7SYNCBIT_W { w: self }
    }
    #[doc = "Bit 15 - FTM global load enable"]
    #[inline(always)]
