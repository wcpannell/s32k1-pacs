...
#[doc = "Field `DISFPCA` reader - SBZP / Disables automatic update of CONTROL.FPCA."]
...
#[doc = "Field `DISFPCA` writer - SBZP / Disables automatic update of CONTROL.FPCA."]
...
impl R {
    ...
    #[doc = "Bit 8 - SBZP / Disables automatic update of CONTROL.FPCA."]
    #[inline(always)]
