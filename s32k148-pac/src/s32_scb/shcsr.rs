...
#[doc = "Field `MEMFAULTACT` reader - MemManage exception active bit, reads as 1 if exception is active"]
...
#[doc = "Field `MEMFAULTACT` writer - MemManage exception active bit, reads as 1 if exception is active"]
...
#[doc = "Field `BUSFAULTACT` reader - BusFault exception active bit, reads as 1 if exception is active"]
...
#[doc = "Field `BUSFAULTACT` writer - BusFault exception active bit, reads as 1 if exception is active"]
...
#[doc = "Field `USGFAULTACT` reader - UsageFault exception active bit, reads as 1 if exception is active"]
...
#[doc = "Field `USGFAULTACT` writer - UsageFault exception active bit, reads as 1 if exception is active"]
...
#[doc = "Field `SVCALLACT` reader - SVCall active bit, reads as 1 if SVC call is active"]
...
#[doc = "Field `SVCALLACT` writer - SVCall active bit, reads as 1 if SVC call is active"]
...
#[doc = "Field `MONITORACT` reader - Debug monitor active bit, reads as 1 if Debug monitor is active"]
...
#[doc = "Field `MONITORACT` writer - Debug monitor active bit, reads as 1 if Debug monitor is active"]
...
#[doc = "Field `PENDSVACT` reader - PendSV exception active bit, reads as 1 if exception is active"]
...
#[doc = "Field `PENDSVACT` writer - PendSV exception active bit, reads as 1 if exception is active"]
...
#[doc = "Field `SYSTICKACT` reader - SysTick exception active bit, reads as 1 if exception is active"]
...
#[doc = "Field `SYSTICKACT` writer - SysTick exception active bit, reads as 1 if exception is active"]
...
#[doc = "Field `USGFAULTPENDED` reader - UsageFault exception pending bit, reads as 1 if exception is pending"]
...
#[doc = "Field `USGFAULTPENDED` writer - UsageFault exception pending bit, reads as 1 if exception is pending"]
...
#[doc = "Field `MEMFAULTPENDED` reader - MemManage exception pending bit, reads as 1 if exception is pending"]
...
#[doc = "Field `MEMFAULTPENDED` writer - MemManage exception pending bit, reads as 1 if exception is pending"]
...
#[doc = "Field `BUSFAULTPENDED` reader - BusFault exception pending bit, reads as 1 if exception is pending"]
...
#[doc = "Field `BUSFAULTPENDED` writer - BusFault exception pending bit, reads as 1 if exception is pending"]
...
#[doc = "Field `MEMFAULTENA` reader - MemManage enable bit, set to 1 to enable"]
...
#[doc = "Field `MEMFAULTENA` writer - MemManage enable bit, set to 1 to enable"]
...
#[doc = "Field `BUSFAULTENA` reader - BusFault enable bit, set to 1 to enable"]
...
#[doc = "Field `BUSFAULTENA` writer - BusFault enable bit, set to 1 to enable"]
...
#[doc = "Field `USGFAULTENA` reader - UsageFault enable bit, set to 1 to enable"]
...
#[doc = "Field `USGFAULTENA` writer - UsageFault enable bit, set to 1 to enable"]
...
impl R {
    #[doc = "Bit 0 - MemManage exception active bit, reads as 1 if exception is active"]
    #[inline(always)]
    pub fn memfaultact(&self) -> MEMFAULTACT_R {
        MEMFAULTACT_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - BusFault exception active bit, reads as 1 if exception is active"]
    #[inline(always)]
    pub fn busfaultact(&self) -> BUSFAULTACT_R {
        BUSFAULTACT_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 3 - UsageFault exception active bit, reads as 1 if exception is active"]
    #[inline(always)]
    pub fn usgfaultact(&self) -> USGFAULTACT_R {
        USGFAULTACT_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 7 - SVCall active bit, reads as 1 if SVC call is active"]
    #[inline(always)]
    pub fn svcallact(&self) -> SVCALLACT_R {
        SVCALLACT_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    #[doc = "Bit 8 - Debug monitor active bit, reads as 1 if Debug monitor is active"]
    #[inline(always)]
    pub fn monitoract(&self) -> MONITORACT_R {
        MONITORACT_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 10 - PendSV exception active bit, reads as 1 if exception is active"]
    #[inline(always)]
    pub fn pendsvact(&self) -> PENDSVACT_R {
        PENDSVACT_R::new(((self.bits >> 10) & 0x01) != 0)
    }
    #[doc = "Bit 11 - SysTick exception active bit, reads as 1 if exception is active"]
    #[inline(always)]
    pub fn systickact(&self) -> SYSTICKACT_R {
        SYSTICKACT_R::new(((self.bits >> 11) & 0x01) != 0)
    }
    #[doc = "Bit 12 - UsageFault exception pending bit, reads as 1 if exception is pending"]
    #[inline(always)]
    pub fn usgfaultpended(&self) -> USGFAULTPENDED_R {
        USGFAULTPENDED_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bit 13 - MemManage exception pending bit, reads as 1 if exception is pending"]
    #[inline(always)]
    pub fn memfaultpended(&self) -> MEMFAULTPENDED_R {
        MEMFAULTPENDED_R::new(((self.bits >> 13) & 0x01) != 0)
    }
    #[doc = "Bit 14 - BusFault exception pending bit, reads as 1 if exception is pending"]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - MemManage enable bit, set to 1 to enable"]
    #[inline(always)]
    pub fn memfaultena(&self) -> MEMFAULTENA_R {
        MEMFAULTENA_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    #[doc = "Bit 17 - BusFault enable bit, set to 1 to enable"]
    #[inline(always)]
    pub fn busfaultena(&self) -> BUSFAULTENA_R {
        BUSFAULTENA_R::new(((self.bits >> 17) & 0x01) != 0)
    }
    #[doc = "Bit 18 - UsageFault enable bit, set to 1 to enable"]
    #[inline(always)]
