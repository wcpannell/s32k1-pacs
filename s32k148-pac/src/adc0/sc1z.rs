#[doc = "Register `SC1Z` reader"]
pub struct R(crate::R<SC1Z_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SC1Z_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SC1Z_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SC1Z_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SC1Z` writer"]
pub struct W(crate::W<SC1Z_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SC1Z_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SC1Z_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SC1Z_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "ADC Status and Control Register 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sc1z](index.html) module"]
pub struct SC1Z_SPEC;
impl crate::RegisterSpec for SC1Z_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sc1z::R](R) reader structure"]
impl crate::Readable for SC1Z_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sc1z::W](W) writer structure"]
impl crate::Writable for SC1Z_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SC1Z to value 0x3f"]
impl crate::Resettable for SC1Z_SPEC {
    #[inline(always)]
