...
#[doc = "Register `FPROT2` writer"]
pub struct W(crate::W<FPROT2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FPROT2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FPROT2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FPROT2_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`write(|w| ..)` method takes [fprot2::W](W) writer structure"]
impl crate::Writable for FPROT2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FPROT2 to value 0"]
