...
#[doc = "Register `FPROT1` writer"]
pub struct W(crate::W<FPROT1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FPROT1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FPROT1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FPROT1_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`write(|w| ..)` method takes [fprot1::W](W) writer structure"]
impl crate::Writable for FPROT1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FPROT1 to value 0"]
