#[doc = "Register `SAI_VERID` reader"]
pub struct R(crate::R<SAI_VERID_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SAI_VERID_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SAI_VERID_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SAI_VERID_SPEC>) -> Self {
        R(reader)
    }
}
...
impl FEATURE_R {
    ...
    pub fn variant(&self) -> Option<FEATURE_A> {
        match self.bits {
            0 => Some(FEATURE_A::_0000000000000000),
            _ => None,
        }
    }
...
#[doc = "Version ID Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sai_verid](index.html) module"]
pub struct SAI_VERID_SPEC;
impl crate::RegisterSpec for SAI_VERID_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sai_verid::R](R) reader structure"]
impl crate::Readable for SAI_VERID_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets SAI_VERID to value 0x0300_0000"]
impl crate::Resettable for SAI_VERID_SPEC {
    #[inline(always)]
