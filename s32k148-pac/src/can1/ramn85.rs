#[doc = "Register `RAMn85` reader"]
pub struct R(crate::R<RAMN85_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RAMN85_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RAMN85_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RAMN85_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RAMn85` writer"]
pub struct W(crate::W<RAMN85_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RAMN85_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RAMN85_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RAMN85_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Embedded RAM\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ramn85](index.html) module"]
pub struct RAMN85_SPEC;
impl crate::RegisterSpec for RAMN85_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ramn85::R](R) reader structure"]
impl crate::Readable for RAMN85_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ramn85::W](W) writer structure"]
impl crate::Writable for RAMN85_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RAMn85 to value 0"]
impl crate::Resettable for RAMN85_SPEC {
    #[inline(always)]
