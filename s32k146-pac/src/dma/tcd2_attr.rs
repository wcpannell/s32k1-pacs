#[doc = "Register `TCD2_ATTR` reader"]
pub struct R(crate::R<TCD2_ATTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TCD2_ATTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TCD2_ATTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TCD2_ATTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TCD2_ATTR` writer"]
pub struct W(crate::W<TCD2_ATTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TCD2_ATTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TCD2_ATTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TCD2_ATTR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct TCD2_ATTR_SPEC;
impl crate::RegisterSpec for TCD2_ATTR_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [tcd2_attr::R](R) reader structure"]
impl crate::Readable for TCD2_ATTR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tcd2_attr::W](W) writer structure"]
impl crate::Writable for TCD2_ATTR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TCD2_ATTR to value 0"]
impl crate::Resettable for TCD2_ATTR_SPEC {
    #[inline(always)]
