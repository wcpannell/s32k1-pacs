#[doc = "Register `DCHPRI15` reader"]
pub struct R(crate::R<DCHPRI15_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCHPRI15_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCHPRI15_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCHPRI15_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCHPRI15` writer"]
pub struct W(crate::W<DCHPRI15_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCHPRI15_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCHPRI15_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCHPRI15_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct DCHPRI15_SPEC;
impl crate::RegisterSpec for DCHPRI15_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [dchpri15::R](R) reader structure"]
impl crate::Readable for DCHPRI15_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dchpri15::W](W) writer structure"]
impl crate::Writable for DCHPRI15_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DCHPRI15 to value 0x0f"]
impl crate::Resettable for DCHPRI15_SPEC {
    #[inline(always)]
