...
pub struct R(crate::R<RF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RF_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "ADC Data Result Registers\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rf](index.html) module"]
pub struct RF_SPEC;
