#[doc = "Register `TIMCTL2` reader"]
pub struct R(crate::R<TIMCTL2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMCTL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIMCTL2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIMCTL2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIMCTL2` writer"]
pub struct W(crate::W<TIMCTL2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIMCTL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIMCTL2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIMCTL2_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Timer Mode\n\nValue on reset: 0"]
...
#[doc = "Timer Control N Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [timctl2](index.html) module"]
pub struct TIMCTL2_SPEC;
impl crate::RegisterSpec for TIMCTL2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [timctl2::R](R) reader structure"]
impl crate::Readable for TIMCTL2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [timctl2::W](W) writer structure"]
impl crate::Writable for TIMCTL2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TIMCTL2 to value 0"]
impl crate::Resettable for TIMCTL2_SPEC {
    #[inline(always)]
