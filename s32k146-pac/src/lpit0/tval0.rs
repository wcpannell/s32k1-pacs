#[doc = "Register `TVAL0` reader"]
pub struct R(crate::R<TVAL0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TVAL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TVAL0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TVAL0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TVAL0` writer"]
pub struct W(crate::W<TVAL0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TVAL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TVAL0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TVAL0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Timer Value\n\nValue on reset: 0"]
...
pub struct TVAL0_SPEC;
impl crate::RegisterSpec for TVAL0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tval0::R](R) reader structure"]
impl crate::Readable for TVAL0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tval0::W](W) writer structure"]
impl crate::Writable for TVAL0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TVAL0 to value 0"]
impl crate::Resettable for TVAL0_SPEC {
    #[inline(always)]
