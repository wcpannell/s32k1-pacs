#[doc = "Register `TRGMUX_LPTMR0` reader"]
pub struct R(crate::R<TRGMUX_LPTMR0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TRGMUX_LPTMR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TRGMUX_LPTMR0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TRGMUX_LPTMR0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TRGMUX_LPTMR0` writer"]
pub struct W(crate::W<TRGMUX_LPTMR0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TRGMUX_LPTMR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TRGMUX_LPTMR0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TRGMUX_LPTMR0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "TRGMUX LPTMR0 Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [trgmux_lptmr0](index.html) module"]
pub struct TRGMUX_LPTMR0_SPEC;
impl crate::RegisterSpec for TRGMUX_LPTMR0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [trgmux_lptmr0::R](R) reader structure"]
impl crate::Readable for TRGMUX_LPTMR0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [trgmux_lptmr0::W](W) writer structure"]
impl crate::Writable for TRGMUX_LPTMR0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TRGMUX_LPTMR0 to value 0"]
impl crate::Resettable for TRGMUX_LPTMR0_SPEC {
    #[inline(always)]
