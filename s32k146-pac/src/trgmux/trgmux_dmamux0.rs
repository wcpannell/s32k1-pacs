#[doc = "Register `TRGMUX_DMAMUX0` reader"]
pub struct R(crate::R<TRGMUX_DMAMUX0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TRGMUX_DMAMUX0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TRGMUX_DMAMUX0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TRGMUX_DMAMUX0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TRGMUX_DMAMUX0` writer"]
pub struct W(crate::W<TRGMUX_DMAMUX0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TRGMUX_DMAMUX0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TRGMUX_DMAMUX0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TRGMUX_DMAMUX0_SPEC>) -> Self {
        W(writer)
    }
}
...
impl R {
    #[doc = "Bits 0:6 - Trigger MUX Input 0 Source Select"]
    #[inline(always)]
    pub fn sel0(&self) -> SEL0_R {
        SEL0_R::new((self.bits & 0x7f) as u8)
    }
    #[doc = "Bits 8:14 - Trigger MUX Input 1 Source Select"]
    #[inline(always)]
    pub fn sel1(&self) -> SEL1_R {
        SEL1_R::new(((self.bits >> 8) & 0x7f) as u8)
    }
    #[doc = "Bits 16:22 - Trigger MUX Input 2 Source Select"]
    #[inline(always)]
    pub fn sel2(&self) -> SEL2_R {
        SEL2_R::new(((self.bits >> 16) & 0x7f) as u8)
    }
    #[doc = "Bits 24:30 - Trigger MUX Input 3 Source Select"]
    #[inline(always)]
    pub fn sel3(&self) -> SEL3_R {
        SEL3_R::new(((self.bits >> 24) & 0x7f) as u8)
    }
...
#[doc = "TRGMUX DMAMUX0 Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [trgmux_dmamux0](index.html) module"]
pub struct TRGMUX_DMAMUX0_SPEC;
impl crate::RegisterSpec for TRGMUX_DMAMUX0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [trgmux_dmamux0::R](R) reader structure"]
impl crate::Readable for TRGMUX_DMAMUX0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [trgmux_dmamux0::W](W) writer structure"]
impl crate::Writable for TRGMUX_DMAMUX0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TRGMUX_DMAMUX0 to value 0"]
impl crate::Resettable for TRGMUX_DMAMUX0_SPEC {
    #[inline(always)]
