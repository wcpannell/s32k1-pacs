#[doc = "Register `C1V_MIRROR` reader"]
pub struct R(crate::R<C1V_MIRROR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C1V_MIRROR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C1V_MIRROR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C1V_MIRROR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C1V_MIRROR` writer"]
pub struct W(crate::W<C1V_MIRROR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C1V_MIRROR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C1V_MIRROR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C1V_MIRROR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Mirror of Channel (n) Match Value\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c1v_mirror](index.html) module"]
pub struct C1V_MIRROR_SPEC;
impl crate::RegisterSpec for C1V_MIRROR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c1v_mirror::R](R) reader structure"]
impl crate::Readable for C1V_MIRROR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c1v_mirror::W](W) writer structure"]
impl crate::Writable for C1V_MIRROR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets C1V_MIRROR to value 0"]
impl crate::Resettable for C1V_MIRROR_SPEC {
    #[inline(always)]
