...
pub struct R(crate::R<GPCHR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPCHR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPCHR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPCHR_SPEC>) -> Self {
        R(reader)
    }
}
...
impl crate::Readable for GPCHR_SPEC {
    type Reader = R;
}
