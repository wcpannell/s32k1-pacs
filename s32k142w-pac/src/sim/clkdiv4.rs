...
impl TRACEDIVEN_R {
    ...
    pub fn variant(&self) -> TRACEDIVEN_A {
        match self.bits {
            false => TRACEDIVEN_A::TRACEDIVEN_0,
            true => TRACEDIVEN_A::TRACEDIVEN_1,
        }
    }
    #[doc = "Checks if the value of the field is `TRACEDIVEN_0`"]
    #[inline(always)]
    pub fn is_tracediven_0(&self) -> bool {
        **self == TRACEDIVEN_A::TRACEDIVEN_0
    }
    #[doc = "Checks if the value of the field is `TRACEDIVEN_1`"]
    #[inline(always)]
    pub fn is_tracediven_1(&self) -> bool {
        **self == TRACEDIVEN_A::TRACEDIVEN_1
    }
}
...
impl<'a> TRACEDIVEN_W<'a> {
    ...
    #[inline(always)]
    pub fn tracediven_0(self) -> &'a mut W {
        self.variant(TRACEDIVEN_A::TRACEDIVEN_0)
    }
    #[doc = "Debug trace divider enabled"]
    #[inline(always)]
    pub fn tracediven_1(self) -> &'a mut W {
        self.variant(TRACEDIVEN_A::TRACEDIVEN_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
