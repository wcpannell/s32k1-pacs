...
impl STOP1_MONITOR_R {
    ...
    pub fn variant(&self) -> STOP1_MONITOR_A {
        match self.bits {
            false => STOP1_MONITOR_A::STOP1_MONITOR_0,
            true => STOP1_MONITOR_A::STOP1_MONITOR_1,
        }
    }
    #[doc = "Checks if the value of the field is `STOP1_MONITOR_0`"]
    #[inline(always)]
    pub fn is_stop1_monitor_0(&self) -> bool {
        **self == STOP1_MONITOR_A::STOP1_MONITOR_0
    }
    #[doc = "Checks if the value of the field is `STOP1_MONITOR_1`"]
    #[inline(always)]
    pub fn is_stop1_monitor_1(&self) -> bool {
        **self == STOP1_MONITOR_A::STOP1_MONITOR_1
    }
}
...
impl<'a> STOP1_MONITOR_W<'a> {
    ...
    #[inline(always)]
    pub fn stop1_monitor_0(self) -> &'a mut W {
        self.variant(STOP1_MONITOR_A::STOP1_MONITOR_0)
    }
    #[doc = "STOP1 entry successful"]
    #[inline(always)]
    pub fn stop1_monitor_1(self) -> &'a mut W {
        self.variant(STOP1_MONITOR_A::STOP1_MONITOR_1)
    }
...
impl STOP2_MONITOR_R {
    ...
    pub fn variant(&self) -> STOP2_MONITOR_A {
        match self.bits {
            false => STOP2_MONITOR_A::STOP2_MONITOR_0,
            true => STOP2_MONITOR_A::STOP2_MONITOR_1,
        }
    }
    #[doc = "Checks if the value of the field is `STOP2_MONITOR_0`"]
    #[inline(always)]
    pub fn is_stop2_monitor_0(&self) -> bool {
        **self == STOP2_MONITOR_A::STOP2_MONITOR_0
    }
    #[doc = "Checks if the value of the field is `STOP2_MONITOR_1`"]
    #[inline(always)]
    pub fn is_stop2_monitor_1(&self) -> bool {
        **self == STOP2_MONITOR_A::STOP2_MONITOR_1
    }
}
...
impl<'a> STOP2_MONITOR_W<'a> {
    ...
    #[inline(always)]
    pub fn stop2_monitor_0(self) -> &'a mut W {
        self.variant(STOP2_MONITOR_A::STOP2_MONITOR_0)
    }
    #[doc = "STOP2 entry successful"]
    #[inline(always)]
    pub fn stop2_monitor_1(self) -> &'a mut W {
        self.variant(STOP2_MONITOR_A::STOP2_MONITOR_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
#[doc = "Field `ECC_EEERAM_STAT` reader - ECC double-bit fault detected during MGATE access to FlexRAM or PRAM"]
pub struct ECC_EEERAM_STAT_R(crate::FieldReader<bool, bool>);
impl ECC_EEERAM_STAT_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        ECC_EEERAM_STAT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ECC_EEERAM_STAT_R {
...
#[doc = "Field `ECC_EEERAM_STAT` writer - ECC double-bit fault detected during MGATE access to FlexRAM or PRAM"]
pub struct ECC_EEERAM_STAT_W<'a> {
    w: &'a mut W,
}
impl<'a> ECC_EEERAM_STAT_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Field `ECC_MGRAM_STAT` reader - ECC double-bit fault detected during MGATE access to Flash firmware or MGRAM"]
pub struct ECC_MGRAM_STAT_R(crate::FieldReader<bool, bool>);
impl ECC_MGRAM_STAT_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        ECC_MGRAM_STAT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ECC_MGRAM_STAT_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `ECC_MGRAM_STAT` writer - ECC double-bit fault detected during MGATE access to Flash firmware or MGRAM"]
pub struct ECC_MGRAM_STAT_W<'a> {
    w: &'a mut W,
}
impl<'a> ECC_MGRAM_STAT_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl FTM0_OBE_CTRL_R {
    ...
    pub fn variant(&self) -> FTM0_OBE_CTRL_A {
        match self.bits {
            false => FTM0_OBE_CTRL_A::FTM0_OBE_CTRL_0,
            true => FTM0_OBE_CTRL_A::FTM0_OBE_CTRL_1,
        }
    }
    #[doc = "Checks if the value of the field is `FTM0_OBE_CTRL_0`"]
    #[inline(always)]
    pub fn is_ftm0_obe_ctrl_0(&self) -> bool {
        **self == FTM0_OBE_CTRL_A::FTM0_OBE_CTRL_0
    }
    #[doc = "Checks if the value of the field is `FTM0_OBE_CTRL_1`"]
    #[inline(always)]
    pub fn is_ftm0_obe_ctrl_1(&self) -> bool {
        **self == FTM0_OBE_CTRL_A::FTM0_OBE_CTRL_1
    }
}
...
= 1'b1). Otherwise the channel output is tristated."]
    #[inline(always)]
    pub fn ftm0_obe_ctrl_0(self) -> &'a mut W {
        self.variant(FTM0_OBE_CTRL_A::FTM0_OBE_CTRL_0)
    }
...
or dual edge capture mode \\[DECAPEN=1'b1\\]."]
    #[inline(always)]
    pub fn ftm0_obe_ctrl_1(self) -> &'a mut W {
        self.variant(FTM0_OBE_CTRL_A::FTM0_OBE_CTRL_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl FTM1_OBE_CTRL_R {
    ...
    pub fn variant(&self) -> FTM1_OBE_CTRL_A {
        match self.bits {
            false => FTM1_OBE_CTRL_A::FTM1_OBE_CTRL_0,
            true => FTM1_OBE_CTRL_A::FTM1_OBE_CTRL_1,
        }
    }
    #[doc = "Checks if the value of the field is `FTM1_OBE_CTRL_0`"]
    #[inline(always)]
    pub fn is_ftm1_obe_ctrl_0(&self) -> bool {
        **self == FTM1_OBE_CTRL_A::FTM1_OBE_CTRL_0
    }
    #[doc = "Checks if the value of the field is `FTM1_OBE_CTRL_1`"]
    #[inline(always)]
    pub fn is_ftm1_obe_ctrl_1(&self) -> bool {
        **self == FTM1_OBE_CTRL_A::FTM1_OBE_CTRL_1
    }
}
...
= 1'b1). Otherwise the channel output is tristated."]
    #[inline(always)]
    pub fn ftm1_obe_ctrl_0(self) -> &'a mut W {
        self.variant(FTM1_OBE_CTRL_A::FTM1_OBE_CTRL_0)
    }
    #[doc = "The FTM channel output state is retained when the channel is in output mode. The output channel is tristated when the channel is in input capture \\[DECAPEN=1'b0, COMBINE=1'b0, MSnB:MSnA=2'b00\\]
or dual edge capture mode \\[DECAPEN=1'b1\\]."]
    #[inline(always)]
    pub fn ftm1_obe_ctrl_1(self) -> &'a mut W {
        self.variant(FTM1_OBE_CTRL_A::FTM1_OBE_CTRL_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl FTM2_OBE_CTRL_R {
    ...
    pub fn variant(&self) -> FTM2_OBE_CTRL_A {
        match self.bits {
            false => FTM2_OBE_CTRL_A::FTM2_OBE_CTRL_0,
            true => FTM2_OBE_CTRL_A::FTM2_OBE_CTRL_1,
        }
    }
    #[doc = "Checks if the value of the field is `FTM2_OBE_CTRL_0`"]
    #[inline(always)]
    pub fn is_ftm2_obe_ctrl_0(&self) -> bool {
        **self == FTM2_OBE_CTRL_A::FTM2_OBE_CTRL_0
    }
    #[doc = "Checks if the value of the field is `FTM2_OBE_CTRL_1`"]
    #[inline(always)]
    pub fn is_ftm2_obe_ctrl_1(&self) -> bool {
        **self == FTM2_OBE_CTRL_A::FTM2_OBE_CTRL_1
    }
}
...
= 1'b1). Otherwise the channel output is tristated."]
    #[inline(always)]
    pub fn ftm2_obe_ctrl_0(self) -> &'a mut W {
        self.variant(FTM2_OBE_CTRL_A::FTM2_OBE_CTRL_0)
    }
    #[doc = "The FTM channel output state is retained when the channel is in output mode. The output channel is tristated when the channel is in input capture \\[DECAPEN=1'b0, COMBINE=1'b0, MSnB:MSnA=2'b00\\]
or dual edge capture mode \\[DECAPEN=1'b1\\]."]
    #[inline(always)]
    pub fn ftm2_obe_ctrl_1(self) -> &'a mut W {
        self.variant(FTM2_OBE_CTRL_A::FTM2_OBE_CTRL_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl FTM3_OBE_CTRL_R {
    ...
    pub fn variant(&self) -> FTM3_OBE_CTRL_A {
        match self.bits {
            false => FTM3_OBE_CTRL_A::FTM3_OBE_CTRL_0,
            true => FTM3_OBE_CTRL_A::FTM3_OBE_CTRL_1,
        }
    }
    #[doc = "Checks if the value of the field is `FTM3_OBE_CTRL_0`"]
    #[inline(always)]
    pub fn is_ftm3_obe_ctrl_0(&self) -> bool {
        **self == FTM3_OBE_CTRL_A::FTM3_OBE_CTRL_0
    }
    #[doc = "Checks if the value of the field is `FTM3_OBE_CTRL_1`"]
    #[inline(always)]
    pub fn is_ftm3_obe_ctrl_1(&self) -> bool {
        **self == FTM3_OBE_CTRL_A::FTM3_OBE_CTRL_1
    }
}
...
= 1'b1). Otherwise the channel output is tristated."]
    #[inline(always)]
    pub fn ftm3_obe_ctrl_0(self) -> &'a mut W {
        self.variant(FTM3_OBE_CTRL_A::FTM3_OBE_CTRL_0)
    }
    #[doc = "The FTM channel output state is retained when the channel is in output mode. The output channel is tristated when the channel is in input capture \\[DECAPEN=1'b0, COMBINE=1'b0, MSnB:MSnA=2'b00\\]
or dual edge capture mode \\[DECAPEN=1'b1\\]."]
    #[inline(always)]
    pub fn ftm3_obe_ctrl_1(self) -> &'a mut W {
        self.variant(FTM3_OBE_CTRL_A::FTM3_OBE_CTRL_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 11 - ECC double-bit fault detected during MGATE access to FlexRAM or PRAM"]
    #[inline(always)]
    pub fn ecc_eeeram_stat(&self) -> ECC_EEERAM_STAT_R {
        ECC_EEERAM_STAT_R::new(((self.bits >> 11) & 0x01) != 0)
    }
    #[doc = "Bit 12 - ECC double-bit fault detected during MGATE access to Flash firmware or MGRAM"]
    #[inline(always)]
    pub fn ecc_mgram_stat(&self) -> ECC_MGRAM_STAT_R {
        ECC_MGRAM_STAT_R::new(((self.bits >> 12) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 11 - ECC double-bit fault detected during MGATE access to FlexRAM or PRAM"]
    #[inline(always)]
    pub fn ecc_eeeram_stat(&mut self) -> ECC_EEERAM_STAT_W {
        ECC_EEERAM_STAT_W { w: self }
    }
    #[doc = "Bit 12 - ECC double-bit fault detected during MGATE access to Flash firmware or MGRAM"]
    #[inline(always)]
    pub fn ecc_mgram_stat(&mut self) -> ECC_MGRAM_STAT_W {
        ECC_MGRAM_STAT_W { w: self }
    }
    #[doc = "Bit 16 - FTM0 OBE CTRL bit"]
    #[inline(always)]
