#[doc = "Register `FLEXIO` reader"]
pub struct R(crate::R<FLEXIO_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FLEXIO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FLEXIO_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FLEXIO_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FLEXIO` writer"]
pub struct W(crate::W<FLEXIO_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FLEXIO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FLEXIO_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FLEXIO_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct FLEXIO_SPEC;
impl crate::RegisterSpec for FLEXIO_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [flexio::R](R) reader structure"]
impl crate::Readable for FLEXIO_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [flexio::W](W) writer structure"]
impl crate::Writable for FLEXIO_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FLEXIO to value 0"]
impl crate::Resettable for FLEXIO_SPEC {
    #[inline(always)]
