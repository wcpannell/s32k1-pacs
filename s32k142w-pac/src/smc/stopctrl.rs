...
impl STOPO_R {
    ...
    pub fn variant(&self) -> Option<STOPO_A> {
        match self.bits {
            1 => Some(STOPO_A::STOPO_1),
            2 => Some(STOPO_A::STOPO_2),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `STOPO_1`"]
    #[inline(always)]
    pub fn is_stopo_1(&self) -> bool {
        **self == STOPO_A::STOPO_1
    }
    #[doc = "Checks if the value of the field is `STOPO_2`"]
    #[inline(always)]
    pub fn is_stopo_2(&self) -> bool {
        **self == STOPO_A::STOPO_2
    }
}
...
impl<'a> STOPO_W<'a> {
    ...
    #[inline(always)]
    pub fn stopo_1(self) -> &'a mut W {
        self.variant(STOPO_A::STOPO_1)
    }
    #[doc = "STOP2 - Stop with system clock disabled and bus clock enabled"]
    #[inline(always)]
    pub fn stopo_2(self) -> &'a mut W {
        self.variant(STOPO_A::STOPO_2)
    }
