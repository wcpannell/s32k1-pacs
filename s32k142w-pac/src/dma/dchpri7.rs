#[doc = "Register `DCHPRI7` reader"]
pub struct R(crate::R<DCHPRI7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCHPRI7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCHPRI7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCHPRI7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCHPRI7` writer"]
pub struct W(crate::W<DCHPRI7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCHPRI7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCHPRI7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCHPRI7_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Priority Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dchpri7](index.html) module"]
pub struct DCHPRI7_SPEC;
impl crate::RegisterSpec for DCHPRI7_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [dchpri7::R](R) reader structure"]
impl crate::Readable for DCHPRI7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dchpri7::W](W) writer structure"]
impl crate::Writable for DCHPRI7_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DCHPRI7 to value 0x07"]
impl crate::Resettable for DCHPRI7_SPEC {
    #[inline(always)]
