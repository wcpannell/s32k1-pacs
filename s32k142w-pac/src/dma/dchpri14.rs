#[doc = "Register `DCHPRI14` reader"]
pub struct R(crate::R<DCHPRI14_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCHPRI14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCHPRI14_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCHPRI14_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCHPRI14` writer"]
pub struct W(crate::W<DCHPRI14_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCHPRI14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCHPRI14_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCHPRI14_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel Priority Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dchpri14](index.html) module"]
pub struct DCHPRI14_SPEC;
impl crate::RegisterSpec for DCHPRI14_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [dchpri14::R](R) reader structure"]
impl crate::Readable for DCHPRI14_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dchpri14::W](W) writer structure"]
impl crate::Writable for DCHPRI14_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DCHPRI14 to value 0x0e"]
impl crate::Resettable for DCHPRI14_SPEC {
    #[inline(always)]
