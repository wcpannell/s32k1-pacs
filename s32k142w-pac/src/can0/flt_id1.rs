...
impl<'a> FLT_RTR_W<'a> {
    ...
    pub fn reject(self) -> &'a mut W {
        self.variant(FLT_RTR_A::REJECT)
    }
    #[doc = "Accept remote frame"]
    #[inline(always)]
    pub fn accept(self) -> &'a mut W {
        self.variant(FLT_RTR_A::ACCEPT)
    }
...
impl FLT_IDE_R {
    ...
    pub fn variant(&self) -> FLT_IDE_A {
        match self.bits {
            false => FLT_IDE_A::STANDARD,
            true => FLT_IDE_A::EXTENDED,
        }
    }
    #[doc = "Checks if the value of the field is `STANDARD`"]
    #[inline(always)]
    pub fn is_standard(&self) -> bool {
        **self == FLT_IDE_A::STANDARD
    }
    #[doc = "Checks if the value of the field is `EXTENDED`"]
    #[inline(always)]
    pub fn is_extended(&self) -> bool {
        **self == FLT_IDE_A::EXTENDED
    }
}
...
impl<'a> FLT_IDE_W<'a> {
    ...
    pub fn standard(self) -> &'a mut W {
        self.variant(FLT_IDE_A::STANDARD)
    }
    #[doc = "Accept extended frame format"]
    #[inline(always)]
    pub fn extended(self) -> &'a mut W {
        self.variant(FLT_IDE_A::EXTENDED)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
