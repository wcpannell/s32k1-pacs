...
impl TIMER_SRC_R {
    ...
    pub fn variant(&self) -> TIMER_SRC_A {
        match self.bits {
            false => TIMER_SRC_A::CAN_BIT_CLOCK,
            true => TIMER_SRC_A::EXTERNAL_CLOCK,
        }
    }
    #[doc = "Checks if the value of the field is `CAN_BIT_CLOCK`"]
    #[inline(always)]
    pub fn is_can_bit_clock(&self) -> bool {
        **self == TIMER_SRC_A::CAN_BIT_CLOCK
    }
    #[doc = "Checks if the value of the field is `EXTERNAL_CLOCK`"]
    #[inline(always)]
    pub fn is_external_clock(&self) -> bool {
        **self == TIMER_SRC_A::EXTERNAL_CLOCK
    }
}
...
impl<'a> TIMER_SRC_W<'a> {
    ...
    #[inline(always)]
    pub fn can_bit_clock(self) -> &'a mut W {
        self.variant(TIMER_SRC_A::CAN_BIT_CLOCK)
    }
    ...
    pub fn external_clock(self) -> &'a mut W {
        self.variant(TIMER_SRC_A::EXTERNAL_CLOCK)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
