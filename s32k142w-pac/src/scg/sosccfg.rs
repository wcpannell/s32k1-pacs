...
impl EREFS_R {
    ...
    pub fn variant(&self) -> EREFS_A {
        match self.bits {
            false => EREFS_A::EREFS_0,
            true => EREFS_A::EREFS_1,
        }
    }
    #[doc = "Checks if the value of the field is `EREFS_0`"]
    #[inline(always)]
    pub fn is_erefs_0(&self) -> bool {
        **self == EREFS_A::EREFS_0
    }
    #[doc = "Checks if the value of the field is `EREFS_1`"]
    #[inline(always)]
    pub fn is_erefs_1(&self) -> bool {
        **self == EREFS_A::EREFS_1
    }
}
...
impl<'a> EREFS_W<'a> {
    ...
    #[inline(always)]
    pub fn erefs_0(self) -> &'a mut W {
        self.variant(EREFS_A::EREFS_0)
    }
    #[doc = "Internal crystal oscillator of OSC selected."]
    #[inline(always)]
    pub fn erefs_1(self) -> &'a mut W {
        self.variant(EREFS_A::EREFS_1)
    }
...
impl HGO_R {
    ...
    #[doc = "Checks if the value of the field is `HGO_0`"]
    #[inline(always)]
    pub fn is_hgo_0(&self) -> bool {
        **self == HGO_A::HGO_0
    }
    #[doc = "Checks if the value of the field is `HGO_1`"]
    #[inline(always)]
    pub fn is_hgo_1(&self) -> bool {
        **self == HGO_A::HGO_1
    }
}
...
impl<'a> HGO_W<'a> {
    ...
    #[inline(always)]
    pub fn hgo_0(self) -> &'a mut W {
        self.variant(HGO_A::HGO_0)
    }
    #[doc = "Configure crystal oscillator for high-gain operation"]
    #[inline(always)]
    pub fn hgo_1(self) -> &'a mut W {
        self.variant(HGO_A::HGO_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl RANGE_R {
    ...
    pub fn variant(&self) -> Option<RANGE_A> {
        match self.bits {
            1 => Some(RANGE_A::RANGE_1),
            2 => Some(RANGE_A::RANGE_2),
            3 => Some(RANGE_A::RANGE_3),
            _ => None,
        }
    }
