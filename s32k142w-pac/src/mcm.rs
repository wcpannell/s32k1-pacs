...
pub struct RegisterBlock {
    ...
    #[doc = "0x400..0x408 - Local Memory Descriptor Register"]
    pub lmdr: [crate::Reg<lmdr::LMDR_SPEC>; 2],
...
pub mod cpo;
#[doc = "LMDR register accessor: an alias for `Reg<LMDR_SPEC>`"]
pub type LMDR = crate::Reg<lmdr::LMDR_SPEC>;
