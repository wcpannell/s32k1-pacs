#[doc = "Register `CV_MIRROR[%s]` reader"]
pub struct R(crate::R<CV_MIRROR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CV_MIRROR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CV_MIRROR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CV_MIRROR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CV_MIRROR[%s]` writer"]
pub struct W(crate::W<CV_MIRROR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CV_MIRROR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CV_MIRROR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CV_MIRROR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Mirror of Channel (n) Match Value\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cv_mirror](index.html) module"]
pub struct CV_MIRROR_SPEC;
impl crate::RegisterSpec for CV_MIRROR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cv_mirror::R](R) reader structure"]
impl crate::Readable for CV_MIRROR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cv_mirror::W](W) writer structure"]
impl crate::Writable for CV_MIRROR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CV_MIRROR[%s]
to value 0"]
impl crate::Resettable for CV_MIRROR_SPEC {
    #[inline(always)]
