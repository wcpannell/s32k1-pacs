...
impl INV0EN_R {
    ...
    pub fn variant(&self) -> INV0EN_A {
        match self.bits {
            false => INV0EN_A::INV0EN_0,
            true => INV0EN_A::INV0EN_1,
        }
    }
    #[doc = "Checks if the value of the field is `INV0EN_0`"]
    #[inline(always)]
    pub fn is_inv0en_0(&self) -> bool {
        **self == INV0EN_A::INV0EN_0
    }
    #[doc = "Checks if the value of the field is `INV0EN_1`"]
    #[inline(always)]
    pub fn is_inv0en_1(&self) -> bool {
        **self == INV0EN_A::INV0EN_1
    }
}
...
impl<'a> INV0EN_W<'a> {
    ...
    #[inline(always)]
    pub fn inv0en_0(self) -> &'a mut W {
        self.variant(INV0EN_A::INV0EN_0)
    }
    #[doc = "Inverting is enabled."]
    #[inline(always)]
    pub fn inv0en_1(self) -> &'a mut W {
        self.variant(INV0EN_A::INV0EN_1)
    }
...
impl INV1EN_R {
    ...
    pub fn variant(&self) -> INV1EN_A {
        match self.bits {
            false => INV1EN_A::INV1EN_0,
            true => INV1EN_A::INV1EN_1,
        }
    }
    #[doc = "Checks if the value of the field is `INV1EN_0`"]
    #[inline(always)]
    pub fn is_inv1en_0(&self) -> bool {
        **self == INV1EN_A::INV1EN_0
    }
    #[doc = "Checks if the value of the field is `INV1EN_1`"]
    #[inline(always)]
    pub fn is_inv1en_1(&self) -> bool {
        **self == INV1EN_A::INV1EN_1
    }
}
...
impl<'a> INV1EN_W<'a> {
    ...
    #[doc = "Inverting is disabled."]
    #[inline(always)]
    pub fn inv1en_0(self) -> &'a mut W {
        self.variant(INV1EN_A::INV1EN_0)
    }
    #[doc = "Inverting is enabled."]
    #[inline(always)]
    pub fn inv1en_1(self) -> &'a mut W {
        self.variant(INV1EN_A::INV1EN_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl INV2EN_R {
    ...
    pub fn variant(&self) -> INV2EN_A {
        match self.bits {
            false => INV2EN_A::INV2EN_0,
            true => INV2EN_A::INV2EN_1,
        }
    }
    #[doc = "Checks if the value of the field is `INV2EN_0`"]
    #[inline(always)]
    pub fn is_inv2en_0(&self) -> bool {
        **self == INV2EN_A::INV2EN_0
    }
    #[doc = "Checks if the value of the field is `INV2EN_1`"]
    #[inline(always)]
    pub fn is_inv2en_1(&self) -> bool {
        **self == INV2EN_A::INV2EN_1
    }
}
...
impl<'a> INV2EN_W<'a> {
    ...
    #[doc = "Inverting is disabled."]
    #[inline(always)]
    pub fn inv2en_0(self) -> &'a mut W {
        self.variant(INV2EN_A::INV2EN_0)
    }
    #[doc = "Inverting is enabled."]
    #[inline(always)]
    pub fn inv2en_1(self) -> &'a mut W {
        self.variant(INV2EN_A::INV2EN_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl INV3EN_R {
    ...
    pub fn variant(&self) -> INV3EN_A {
        match self.bits {
            false => INV3EN_A::INV3EN_0,
            true => INV3EN_A::INV3EN_1,
        }
    }
    #[doc = "Checks if the value of the field is `INV3EN_0`"]
    #[inline(always)]
    pub fn is_inv3en_0(&self) -> bool {
        **self == INV3EN_A::INV3EN_0
    }
    #[doc = "Checks if the value of the field is `INV3EN_1`"]
    #[inline(always)]
    pub fn is_inv3en_1(&self) -> bool {
        **self == INV3EN_A::INV3EN_1
    }
}
...
impl<'a> INV3EN_W<'a> {
    ...
    #[doc = "Inverting is disabled."]
    #[inline(always)]
    pub fn inv3en_0(self) -> &'a mut W {
        self.variant(INV3EN_A::INV3EN_0)
    }
    #[doc = "Inverting is enabled."]
    #[inline(always)]
    pub fn inv3en_1(self) -> &'a mut W {
        self.variant(INV3EN_A::INV3EN_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
