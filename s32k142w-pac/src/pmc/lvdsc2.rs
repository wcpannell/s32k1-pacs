...
impl LVWIE_R {
    ...
    pub fn variant(&self) -> LVWIE_A {
        match self.bits {
            false => LVWIE_A::LVWIE_0,
            true => LVWIE_A::LVWIE_1,
        }
    }
    #[doc = "Checks if the value of the field is `LVWIE_0`"]
    #[inline(always)]
    pub fn is_lvwie_0(&self) -> bool {
        **self == LVWIE_A::LVWIE_0
    }
    #[doc = "Checks if the value of the field is `LVWIE_1`"]
    #[inline(always)]
    pub fn is_lvwie_1(&self) -> bool {
        **self == LVWIE_A::LVWIE_1
    }
}
...
impl<'a> LVWIE_W<'a> {
    ...
    #[inline(always)]
    pub fn lvwie_0(self) -> &'a mut W {
        self.variant(LVWIE_A::LVWIE_0)
    }
    #[doc = "Request a hardware interrupt when LVWF=1"]
    #[inline(always)]
    pub fn lvwie_1(self) -> &'a mut W {
        self.variant(LVWIE_A::LVWIE_1)
    }
...
impl LVWF_R {
    ...
    #[doc = "Checks if the value of the field is `LVWF_0`"]
    #[inline(always)]
    pub fn is_lvwf_0(&self) -> bool {
        **self == LVWF_A::LVWF_0
    }
    #[doc = "Checks if the value of the field is `LVWF_1`"]
    #[inline(always)]
    pub fn is_lvwf_1(&self) -> bool {
        **self == LVWF_A::LVWF_1
    }
}
