#[doc = "Register `CP0CFG3` reader"]
pub struct R(crate::R<CP0CFG3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CP0CFG3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CP0CFG3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CP0CFG3_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Processor 0 Configuration Register 3\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cp0cfg3](index.html) module"]
pub struct CP0CFG3_SPEC;
impl crate::RegisterSpec for CP0CFG3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cp0cfg3::R](R) reader structure"]
impl crate::Readable for CP0CFG3_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CP0CFG3 to value 0x0101"]
impl crate::Resettable for CP0CFG3_SPEC {
    #[inline(always)]
